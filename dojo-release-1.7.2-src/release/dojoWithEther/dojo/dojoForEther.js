...
'url:dijit/templates/ProgressBar.html':"<div class=\"dijitProgressBar dijitProgressBarEmpty\" role=\"progressbar\"\n\t><div  data-dojo-attach-point=\"internalProgress\" class=\"dijitProgressBarFull\"\n\t\t><div class=\"dijitProgressBarTile\" role=\"presentation\"></div\n\t\t><span style=\"visibility:hidden\">&#160;</span\n\t></div\n\t><div data-dojo-attach-point=\"labelNode\" class=\"dijitProgressBarLabel\" id=\"${id}_label\"></div\n\t><img data-dojo-attach-point=\"indeterminateHighContrastImage\" class=\"dijitProgressBarIndeterminateHighContrastImage\" alt=\"\"\n/></div>\n",
'ether/DZContainer':function(){
define("ether/DZContainer", ['dojo/_base/declare','dojo/query','dojo/dnd/autoscroll','ether/CibleEnvoi','ether/tap'],
	function(declare)
	{
...
switch(_9.context.c){
case 1:
this.fire(e.target,{type:"tap",position:{x:e.clientX,y:e.clientY}});
break;
case 2:
e.target.tapX=e.clientX; e.target.tapY=e.clientY;
this.fire(e.target,{type:"tap.doubletap",position:{x:e.clientX,y:e.clientY}});
...
=====*/
	...
	//		ether/MenuItem
	// summary:
	//		An inactive line item in a Menu Widget


	return declare("ether.MenuItem",
		[_Widget, _TemplatedMixin, _Contained, _CssStateMixin],
		{
		// summary:
		//		A line item in a Menu Widget
...
i18n._preloadLocalizations("dojo/nls/dojoForEther", ["nl-nl","en-us","da","fi-fi","pt-pt","hu","sk","sl","pl","ca","sv","zh-tw","ar","en-gb","he-il","de-de","ko-kr","ja-jp","nb","ru","es-es","th","cs","it-it","pt-br","fr-fr","el","tr","zh-cn"]);
});
define("dojo/dojoForEther", [], 1);
